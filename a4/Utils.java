...
{	public Utils() {}
	...
	public static int loadTexture(String textureFileName, boolean tiled)
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		int finalTextureRef;
		Texture tex = null;
	...
	// OLD material
	public static float[] oldAmbient()  { return (new float [] {0.0473f,  0.0995f, 0.0745f, 1} ); }
	public static float[] oldDiffuse()  { return (new float [] {0.05f,  0.7065f, 0.7065f, 1} ); }
	public static float[] oldSpecular() { return (new float [] {0.0283f,  0.0559f, 0.0661f, 1} ); }
	public static float oldShininess()  { return 5.2f; }
	...
	public static float[] rubberGAmbient()  { return (new float [] {0.0f,  0.05f, 0.0f, 1} ); }
    public static float[] rubberGDiffuse()  { return (new float [] {0.4f,  0.5f, 0.4f, 1} ); }
    public static float[] rubberGSpecular() { return (new float [] {0.04f,  0.7f, 0.04f, 1} ); }
    public static float rubberGShininess()  { return 0.078125f; }
}